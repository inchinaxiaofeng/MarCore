...
abstract class AXI4SlaveModule[T <: AXI4Lite, B <: Data](_type: T = new AXI4, _extra: B = null) extends Module with HasMarCoreParameter {
	...
	val fullMask = MaskExpend(in.w.bits.strb)
