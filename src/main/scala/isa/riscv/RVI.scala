...
object RV32I_BRUInstr extends HasInstrType {
	...
	val bruCtrl2BtbTypeTable = List (
		...
		ALUCtrl.blt		-> BTBtype.B,
		ALUCtrl.bge		-> BTBtype.B,
		ALUCtrl.bltu	-> BTBtype.B,
		ALUCtrl.bgeu	-> BTBtype.B,
		ALUCtrl.call	-> BTBtype.J,
		ALUCtrl.ret		-> BTBtype.R,
		ALUCtrl.jal		-> BTBtype.J,
		ALUCtrl.jalr	-> BTBtype.I
	)
}
