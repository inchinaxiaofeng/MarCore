...
object LA32R_ArithInstr extends HasLA32R_InstrType {
  ...
  def SUBW = BitPat("b00_00000_00001_00010_?????_?????_?????")
  def ADDIW = BitPat("b00_00001_010??_?????_?????_?????_?????")
  def LU12IW = BitPat("b00_01010_?????_?????_?????_?????_?????")
  def SLT = BitPat("b00_00000_00001_00100_?????_?????_?????")
  def SLTU = BitPat("b00_00000_00001_00101_?????_?????_?????")
  def SLTI = BitPat("b00_00001_000??_?????_?????_?????_?????")
  def SLTUI = BitPat("b00_00001_001??_?????_?????_?????_?????")
  def PCADDU12I = BitPat("b00_01110_?????_?????_?????_?????_?????")
  def AND = BitPat("b00_00000_00001_01001_?????_?????_?????")
  def OR = BitPat("b00_00000_00001_01010_?????_?????_?????")
  def NOR = BitPat("b00_00000_00001_01000_?????_?????_?????")
  def XOR = BitPat("b00_00000_00001_01011_?????_?????_?????")
  def ANDI = BitPat("b00_00001_110??_?????_?????_?????_?????")
  def ORI = BitPat("b00_00001_110??_?????_?????_?????_?????")
  def XORI = BitPat("b00_00001_111??_?????_?????_?????_?????")
  def MULW = BitPat("b00_00000_00001_11000_?????_?????_?????")
  def MULHW = BitPat("b00_00000_00001_11001_?????_?????_?????")
  def MULHWU = BitPat("b00_00000_00001_11010_?????_?????_?????")
  def DIVW = BitPat("b00_00000_00010_00000_?????_?????_?????")
  def DIVWU = BitPat("b00_00000_00010_00010_?????_?????_?????")
  def MODW = BitPat("b00_00000_00010_00001_?????_?????_?????")
  def MODWU = BitPat("b00_00000_00010_00011_?????_?????_?????")
...
object LA32R_ShiftInstr extends HasLA32R_InstrType {
  def SLLW = BitPat("b00_00000_00001_01110_?????_?????_?????")
  def SRLW = BitPat("b00_00000_00001_01111_?????_?????_?????")
  def SRAW = BitPat("b00_00000_00001_10000_?????_?????_?????")
  def SLLIW = BitPat("b00_00000_00100_00001_?????_?????_?????")
  def SRLIW = BitPat("b00_00000_00100_01001_?????_?????_?????")
  def SRAIW = BitPat("b00_00000_00100_10001_?????_?????_?????")
...
object LA32R_JumpInstr extends HasLA32R_InstrType {
  def BEQ = BitPat("b01_0110?_?????_?????_?????_?????_?????")
  def BNE = BitPat("b01_0111?_?????_?????_?????_?????_?????")
  def BLT = BitPat("b01_1000?_?????_?????_?????_?????_?????")
  def BGE = BitPat("b01_1001?_?????_?????_?????_?????_?????")
  def BLTU = BitPat("b01_1010?_?????_?????_?????_?????_?????")
  def BGEU = BitPat("b01_1011?_?????_?????_?????_?????_?????")
  def B = BitPat("b01_0100?_?????_?????_?????_?????_?????")
  def BL = BitPat("b01_0101?_?????_?????_?????_?????_?????")
  def JIRL = BitPat("b01_0011?_?????_?????_?????_?????_?????")
...
object LA32R_AccessInstr extends HasLA32R_InstrType {
  def LDB = BitPat("b00_10100_000??_?????_?????_?????_?????")
  def LDH = BitPat("b00_10100_001??_?????_?????_?????_?????")
  def LDW = BitPat("b00_10100_010??_?????_?????_?????_?????")
  def LDBU = BitPat("b00_10101_000??_?????_?????_?????_?????")
  def LDHU = BitPat("b00_10101_001??_?????_?????_?????_?????")
  def STB = BitPat("b00_10100_100??_?????_?????_?????_?????")
  def STH = BitPat("b00_10100_101??_?????_?????_?????_?????")
  def STW = BitPat("b00_10100_110??_?????_?????_?????_?????")
  def PRELD = BitPat("b00_10101_011??_?????_?????_?????_?????")
