...
// }
//
// class soc_axi_sram_bridge
//     extends BlackBox(
//       Map("BUS_WIDTH" -> 32, "DATA_WIDTH" -> 64, "CPU_WIDTH" -> 32)
//     ) {
...
//     io.pc := RegNext(
//       Mux(
//         core.io.difftest_redirect.get.valid,
...
//
//   Debug(
//     "[RAM] raddr %x rdata %x ren %d waddr %x wdata %x wen %b\n",
//     bridge.io.ram_raddr,
//     bridge.io.ram_rdata,
//     bridge.io.ram_ren,
//     bridge.io.ram_waddr,
