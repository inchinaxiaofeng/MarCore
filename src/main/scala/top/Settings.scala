...
case class VGAMode(mode:String,
	hsync:Int, hback:Int, hleft:Int, hvalid:Int, hright:Int, hfront:Int, htotal:Int,
	vsync:Int, vback:Int, vtop:Int, vvalid:Int, vbottom:Int, vfront:Int, vtotal:Int)
...
object VGAMode extends Enumeration {
	val _640x480at60	= VGAMode("640x480@60",
		96, 40, 8, 640, 8, 8, 800,
		2, 25, 8, 480, 8, 2, 525)
	val _640x480at75	= VGAMode("640x480@75",
		64, 120, 0, 640, 0, 16, 840,
		3, 16, 0, 480, 0, 1, 500)
	val _800x600at60	= VGAMode("800x600@60",
		128, 88, 0, 800, 0, 40, 1056,
		4, 23, 0, 600, 0, 1, 628)
	val _800x600at75	= VGAMode("800x600@75",
		80, 160, 0, 800, 0, 16, 1056,
		3, 21, 0, 600, 0, 1, 625)
	val _1025x768at60	= VGAMode("1024x768@60",
		136, 160, 0, 1024, 0, 24, 1344,
		6, 29, 0, 768, 0, 3, 806)
	val _1024x768at75	= VGAMode("1024x768@75",
		176, 176, 0, 1024, 0, 16, 1312,
		3, 28, 0, 768, 0, 3, 806)
	val _1280x1024at60	= VGAMode("1280x1024@60",
		112, 248, 0, 1280, 0, 48, 1688,
		3, 38, 0, 1024, 0, 1, 1066)
}
